  ...
  return (
    <div className="App">
      ...
      <div className="App-grid">
        ...
        <div className="Grid-item-train">central station</div><div ></div><div >DimSum</div><div ></div><div className="Grid-item-train">skyway Station</div>
        <div className="App-grid-item">bobba city</div><div ></div><div ></div><div ></div><div className="App-grid-item">Pho Now #5</div>
        <div className="App-grid-item">start</div><div className="App-grid-item">Dragon Dumplings</div><div className="App-grid-item">Peddle Power Hut</div><div className="App-grid-item">Scallion House</div><div className="App-grid-item">Oolong Temple</div>
      </div>
      <div> right </div>
    </div>
  );
