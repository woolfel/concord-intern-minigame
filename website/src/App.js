  ...
  return (
    <div className="App">
      ...
      <div className="App-grid">
        ...
        <div className="App-grid-item" id="sq1">start</div><div className="App-grid-item2" id="sq17">Dragon Dumplings</div><div className="Grid-item-car" id="sq16">Shared Ride</div><div className="App-grid-item2" id="sq14">Scallion House<p><img src="./resources/scallion.png"></img></p></div><div className="App-grid-item" id="sq13">Oolong Temple</div>
      </div>
